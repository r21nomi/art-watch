...
URL="https://api.github.com/repos/$CIRCLE_PROJECT_USERNAME/$CIRCLE_PROJECT_REPONAME/releases/tags/$CIRCLE_TAG"

UPLOAD_URL=echo $URL | sed -e 's/{?name,label}/?name=/g' | sed -e 's/"//g'
